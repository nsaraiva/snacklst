...
function SnacklstController(){
    ...
    return (
        <div>
            ...
            <button onClick={() =>addComment(snacklst[0].id as Uuid, {id: 'TestId', text: 'Comment...', userId: 'Eu mesmo'})}>Add Comment</button>
            ...
            <button onClick={() =>downVote(snacklst[0].id as Uuid)}>Remove like</button>
        </div>
    );
}
